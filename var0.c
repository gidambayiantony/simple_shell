#include "code.h"
/**
 * is_chain -checks current char in buffer is a chain delimeter
 * @info:  Par Structure
 * @buf: Char Buff
 * @p: Address of buf
 *
...
/**
 * check_chain -test the entry point
 * @info: Param Struct
 * @buf: Buff Char
...
/**
 * replace_alias -it  Replaces  aliases
